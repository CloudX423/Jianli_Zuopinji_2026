  ...
  return (
    <div className="relative w-full">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center gap-3 pb-1 md:hidden">
          ...
          <p className="text-white font-semibold text-center mt-2 text-base">
